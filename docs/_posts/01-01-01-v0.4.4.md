...
I'll also be adding support for git command options clone and config to coincide with "terminal-first" effort mentioned elsewhere.
...
- [ ] service worker uses git config
