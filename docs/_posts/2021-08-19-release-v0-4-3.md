...
description: "file operations, git, preview, terminal, editor state, editor mini-map, context menu items"
...
A quick note about this, I also made sure file operations work with the **git** abstraction.  The changes you make in fiug will persist to your github repository when you push a commit.  
...
*(Is this dry or what?  Who reads release notes?  Props to you if you do!)*
