...
**editor mini-map** was added and is mostly done, but still a little buggy.
...
There were a few other little things that it's not worth going over; feel free to reference the full list of changes follow.
