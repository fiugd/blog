...
- [ ] service worker should:
	...
	- [ ] use .git/config for credentials, local first then global
- [X] file "##PLACEHOLDER##"
...
Here's a song I just discovered: [Company by Vanderlay](https://www.youtube.com/watch?v=VsWfQP-XDaA)

![]({https://www.youtube.com/watch?v=VsWfQP-XDaA})
